...
import { CAR_FORM_FIELDS, CAR_FROM_SEAT } from "../../../../constants/CarFormField";
...
function RequestForm(){
    ...
    useEffect(() => {
        ...
        else if(!loading && isLoading.current == false && user && user.role !== "seller"){
    ...
    const handleSubmit = async () => {
        ...
        try {
            const responseCreateForm = await axios.post(`${import.meta.env.VITE_SERVER_URL}/api/v1/requestAdd`, DataSend, {
            ...
            <div className="requestform">
                ...
                <div className="requestform__progress__contain">
                    <ul className="requestform__progress">
                        ...
                        <li className="requestform__progress__future">
                            2. Đợi xác thực
                        </li>
                        <li className="requestform__progress__horizontal"></li>
                        <li className="requestform__progress__future">
                ...
                <div className="requestform__contain">
                    <div className="requestform__box">
                        <h4 className="requestform__question">
                            ...
                            <span className="requestform__question__title">Tên phương tiện</span>
                        </h4>
                        <div className="requestform__content">
                            <input type="text" name="name" className="requestform__content__input" placeholder="Tên phương tiện..." id="rq_name" value={formInfo.name} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="requestform__box">
                        ...
                        <div className="requestform__content">
                            <input type="number" name="year" placeholder="năm mua xe..." className="requestform__content__input" min="1000" max="2025" id="rq_year" value={formInfo.year} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="requestform__box">
                        <h4 className="requestform__question">
                            ...
                            <span className="requestform__question__title">Số kilomet đã đi</span>
                        </h4>
                        <div className="requestform__content">
                            <input type="number" name="km" placeholder="số km đã đi" className="requestform__content__input" id="rq_km" value={formInfo.km} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="requestform__box">
                        <h4 className="requestform__question">
                            ...
                            <span className="requestform__question__title">Loại nhiên liệu sử dụng</span>
                        </h4>
                        <div className="requestform__content">
                            <ul className="requestform__content__list">
                                {
                                    ...
                                    CAR_FORM_FIELDS.map((fuel, f_index) => (
                                        <li key={f_index} className={"requestform__content__item " + (fuel.fuel_type === formInfo.fuel ? "picked" : "")} onClick={() => {handlePick('fuel', fuel.fuel_type)}}>
                                            <div className="requestform__content__item__icon">{fuel.fuel_icon}</div>
                                            <span className="requestform__content__item__span">{fuel.fuel_name}</span>
                                        </li>
                                    ))
                                }
                            </ul>
                            ...
                            <ul className="requestform__content__list">
                                {
                                    ...
                                    CAR_FROM_SEAT.map((seat, s_index) => (
                                        <li key={s_index} className={"requestform__content__item " + (seat.seat_capacity === formInfo.seat_capacity ? "picked" : "")} onClick={() => {handlePick('seat_capacity', seat.seat_capacity)}}>
                                            <div className="requestform__content__item__icon">{seat.seat_icon}</div>
                                            <span className="requestform__content__item__span">{seat.seat_capacity}</span>
                                        </li>
                                    ))
                                }
                            </ul>
                    ...
                    <div className="requestform__box">
                        <h4 className="requestform__question">
                            ...
                            <span className="requestform__question__title">Địa điểm muốn kiểm tra</span>
                        </h4>
                        <div className="requestform__content">
                            <input type="text" placeholder="địa điểm kiểm tra" name="location" className="requestform__content__input" id="rq_location" value={formInfo.location} onChange={handleChange} />
                        </div>
                    </div>
                    ...
                    <div className="requestform__box">
                        <h4 className="requestform__question">
                            <TbCircleNumber6 className="requestform__question__number"/>
                            <span className="requestform__question__title">Hình ảnh minh họa</span>
                        </h4>
                        <div className="requestform__content">
                            {
                                !uploadImage ? 
                                ...
                                (
                                    <>
                                        <div className="requestform__uploadedImage">
                                            <button className="requestform__uploadedImage__button" onClick={() => {setUploadImage("")}} >x</button>
                                            <img className="requestform__uploadedImage__image" src={isImageUrlOrDefault(uploadImage)} alt="imagePreview" />
                                        </div>
                                    </>
                                )
                            }
                    ...
                    <div className="requestform__submit">
                        <button className="requestform__submit__button" onClick={handleSubmit}>
                            Xác nhận
                        </button>
                    </div>
                </div>
