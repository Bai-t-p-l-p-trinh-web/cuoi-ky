...
function Message(){
    ...
    useEffect(() => {
        const getMessages = async() => {
            try {
                const res = await axios.get(`${import.meta.env.VITE_SERVER_URL}/api/v1/thread/threads`, {
    ...
    const chattingSuccess = (data) => {
        ...
        setChats((prev) => {
            ...
            let indexThread = newChats.threads.findIndex(thread => thread.threadId === threadId);
                                ...
                                <div className="chat__messages__users">
                                    {
                                        chats.threads.map((thread, index) => {
                                            ...
                                            const otherUserId = thread.user1Id === chats.id ? thread.user2Id : thread.user1Id;
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="chat__messages__users__user-avatar__contain" data-user-online={onlineUsers.includes(otherUserId)}>
                                                        <img 
                                                            className="chat__messages__users__user-avatar" 
                                                            src={otherUser.avatar} alt="avatar" 
                                        ...
                                        selectedThread ? (
                                            <div className="chat__chatting">
                                                ...
                                                <div className="chat__chatting__content" ref={bottomRef}>
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className={"chat__chatting__content__box " + (msg.senderId === chats.id ? "me " : " ")}>
                                                                        ...
                                                                        <div className="chat__chatting__content__box__contain">
                                                                            ...
                                                                            <p className={`chat__chatting__content__box-text ${chats.id === msg.senderId ? "sender" : ""}`}>
                                                                                {msg.text}
                                                                            </p>
                                                                        </div>
                                                    ...
                                                    <div className={`chat__chatting__content__typing ${((selectedThread.user1Id !== user._id && onlineUsersTyping.includes(selectedThread.user1Id)) || (selectedThread.user2Id !== user._id && onlineUsersTyping.includes(selectedThread.user2Id))) ? 'typing' : ''}`}>
                                                        <span></span>
                                                        <span></span>
                                                        <span></span>
                                                    </div>
                                                ...
                                                <div className="chat__input__container">
                                                    <textarea
                                                        ...
                                                        value={textMessage}
                                                        onChange={(e) => {handleChange(e, selectedThread.threadId)}}
                                                        onKeyDown={(e) => {sendMessage(e, selectedThread.threadId)}}
                                                        rows={1}
                                                    />
                                                    <button onClick={(e) => {buttonSendMessage(e, selectedThread.threadId)}} className="chat__input__button">
                                                        <IoMdSend/>
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div className="chat__title">
                                ...
                                <div className="chat__extend">
                                    ...
                                    <div className="chat__user">
                                        ...
                                        <div className="chat__user__info">
                                            <Skeleton width={100} height={20} className="chat__user__info-name"/>
                                            <Skeleton width={200} height={15} className="chat__user__info-email"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="chat__messages__users">
                                    {Array(4).fill().map((_, idx) => (
                                        <div className="chat__messages__users__user" key={idx}>
                                            <Skeleton circle height={50} width={50} style={{marginRight : "10px"}} />
                                ...
                                <div className="chat__messages__conversation">
                                    <div className="chat__chatting">
                                        <div className="chat__chatting__header">
                                            <div className="chat__chatting__header__info">
                                                <Skeleton height={60} width={60} circle style={{marginRight : "15px"}}/>
                                                <div>
                                    ...
                                    <div className="chat__chatting__content">
                                        {Array(5).fill().map((_, idx) => (
                                            <div className="chat__chatting__content-item" key={idx} style={{marginBottom : "20px"}}>
