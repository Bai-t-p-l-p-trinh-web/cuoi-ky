...
function ManageCar() {
    ...
    const FilterBySort = (sort) => {
        ...
        if (sort === 'asc') {
            ...
            resultFilter.current = resultFilter.current.sort((a, b) => b.price - b.price);
        }
    };
    ...
    const renderPageNumbers = () => {
        ...
        for (let i = startPage; i <= endPage; i++) {
            pageNumbers.push(
                <button
                    key={i}
                    className={`manageCar__pagination__button ${currentPage === i ? 'active' : ''}`}
                ...
                <div className="manageCar__contain">
                    <div className="manageCar__options">
                        <ul className="manageCar__status__list">
                            ...
                            <li className={`manageCar__status ${filterCar.status === 'hidden' ? 'picked' : ''}`} onClick={() => handleChangeStatus('hidden')}>
                        ...
                        <div className="manageCar__filters">
                            ...
                            <div className="manageCar__sort">
                                <button className="manageCar__sort__button" onClick={handleChangeSort}>
                                    {!filterCar.sort && <img src="/unsorted.svg" alt="unsorted" />}
                                ...
                                currentCars.map((car, c_index) => (
                                    <tr key={c_index} className="manageCar__table__tr">
                                        ...
                                        <td className="manageCar__table__td--functions">
                                            <Link to={`/${car.slug}`} className="manageCar__functions__link">
                                                <CgDetailsMore className="manageCar__functions__svg" />
                                                <span className="manageCar__functions__span">Chi tiết</span>
                                            </Link>
                                            <Link to={`/my_account/edit-car/${car.slug}`} className="manageCar__functions__link edit">
