                    ...
                    <ul className="myAccount__pages__list">
                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="">
                                ...
                                <span className="myAccount__pages__item__span">Trang tổng quan</span>   
                            </Link>
                        </li>
                        ...
                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="manage-car">
                                ...
                                <span className="myAccount__pages__item__span">Quản lý đăng bán xe</span>   
                            </Link>
                        </li>

                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="statistics/sales">
                                <PiCarLight className="myAccount__pages__item__link__svg"/>
                                <span className="myAccount__pages__item__span">Thống kê bán hàng</span>   
                            </Link>
                        </li>

                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="statistics/insights">
                                <TbEyeShare className="myAccount__pages__item__link__svg"/>
                                <span className="myAccount__pages__item__span">Thống kê lượt xem / tương tác</span>   
                            </Link>
                        </li>

                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="inspection-history">
                                <FcInspection className="myAccount__pages__item__link__svg"/>
                                <span className="myAccount__pages__item__span">Thông tin / lịch sử kiểm định</span>   
                            </Link>
                        </li>
                        ...
                        <li className="myAccount__pages__item">
                            <Link className="myAccount__pages__item__link" to="faq">
                                ...
                                <span className="myAccount__pages__item__span">Hướng dẫn / FAQ</span>   
                            </Link>
                        </li>

                        <li className="myAccount__pages__item logout">
                            <button className="myAccount__pages__logout" onClick={handleLogout}>
                                <CiLogout className="myAccount__pages__logout__svg"/>
                                <span className="myAccount__pages__logout__span">Đăng xuất</span>
