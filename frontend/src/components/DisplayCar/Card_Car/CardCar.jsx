  ...
  return (
    <>
      <div className="home__content__main__display__list-item--description">
        ...
        <h3 className="home__content__main__display__list-item--description-name">
          {item.title}
        </h3>
        <div className="home__content__main__display__list-item--description-specific">
          <div className="home__content__main__display__list-item--description-specific--year">
            <SlCalender /> <span>{item.year}</span>{" "}
          </div>
          <div className="home__content__main__display__list-item--description-specific--km">
