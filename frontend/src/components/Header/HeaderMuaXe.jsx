      ...
      <div className="header__dropdownMuaXe">
        <div className="header__dropdownMuaXe__top">
          <div className="header__dropdownMuaXe__top-hang">
            <h3 className="header__dropdownMuaXe__top-hangTitle">
              HÃNG XE PHỔ BIẾN
            </h3>
            <ul className="header__dropdownMuaXe__top-hangList">
              <li className="header__dropdownMuaXe__top-hangList-item">
                Toyota
              </li>
              <li className="header__dropdownMuaXe__top-hangList-item">
                Honda
          ...
          <div className="header__dropdownMuaXe__top-dong">
            <h3 className="header__dropdownMuaXe__top-dongTitle">
              DÒNG XE PHỔ BIẾN
            </h3>
            <ul className="header__dropdownMuaXe__top-dongList">
              <li className="header__dropdownMuaXe__top-dongList-item">
          ...
          <div className="header__dropdownMuaXe__top-gia">
            ...
            <ul className="header__dropdownMuaXe__top-giaList">
              <li className="header__dropdownMuaXe__top-giaList-item">
                Dưới 500 triệu
              </li>
              <li className="header__dropdownMuaXe__top-giaList-item">
                Từ 500 - 700 triệu
        ...
        <Link to="/xe-o-to" className="header__dropdownMuaXe__bottom">
          Xem tất cả xe
        </Link>
      </div>
    </>
