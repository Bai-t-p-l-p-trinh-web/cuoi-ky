...
io.on('connection', (socket) => {
  ...
  socket.on('send-message', async (data) => {
    ...
    const respondSending = await chatServices.sendMessages(threadId, senderId, text);
  ...
  socket.on('user-typing', async(data) => {
    ...
    const respondGetOtherUserId = await chatServices.findOtherUserIdByThreadId(userId, threadId);
